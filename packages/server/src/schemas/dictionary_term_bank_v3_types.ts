...
/**
 * Utility functions for working with dictionary types
 */
export const DictionaryTypes = {
  /** Check if a definition is a text definition */
  isTextDefinition: (def: Definition): def is string => {
    return typeof def === "string";
  },

  /** Check if a definition is a detailed definition */
  isDetailedDefinition: (def: Definition): def is DetailedDefinition => {
    return typeof def === "object" && def !== null;
  },

  /** Check if a definition is a deinflection */
  isDeinflection: (def: Definition): def is Deinflection => {
    return typeof def === "object" && def !== null && "type" in def === false;
  },

  /** Check if structured content is text */
  isTextContent: (content: StructuredContent): content is string => {
    return typeof content === "string";
  },

  /** Check if structured content is an array */
  isArrayContent: (content: StructuredContent): content is StructuredContent[] => {
    return Array.isArray(content);
  },

  /** Check if structured content is an object */
  isObjectContent: (content: StructuredContent): content is StructuredContentObject => {
    return typeof content === "object" && content !== null;
  },

  /** Get the tag name from a structured content object */
  getTagName: (content: StructuredContentObject): string => {
    return content.tag;
  },
} as const;
